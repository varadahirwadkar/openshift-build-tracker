def call(String auth_url, String distro, String filter){
    ...
    switch(distro) {
        ...
        case "RHEL8.2":
            ...
            break
        case "RHEL8.3":
            IMAGE=sh(returnStdout: true, script: "openstack --os-auth-url \"${auth_url}\" --insecure image list  --format value -c Name | grep -i rhel8.3| tail -n 1|tr '\n' ' ' ").trim()
            env.DISTRO="rhel"
